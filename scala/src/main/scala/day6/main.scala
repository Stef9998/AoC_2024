...
//TODO:
// - move the solution of sample and real input to some text file like the sample & real input
//   that way we can run the code without having to modify the asserts for every day
