...
def do_calc_iterator(list_iterator: Iterator[tuple[Coordinate, Coordinate, Coordinate]]) -> Iterator[tuple[int, int]]:
    button_presses = (get_button_presses_all(button_a_movement, button_b_movement, prize) for button_a_movement, button_b_movement, prize in list_iterator)
...
def correct_unit_conversion(data: list[tuple[Coordinate, Coordinate, Coordinate]]) -> Iterator[tuple[Coordinate, Coordinate, Coordinate]]:
    return ((button_a, button_b, Coordinate(prize.x + 10000000000000, prize.y + 10000000000000)) for button_a, button_b, prize in data)
